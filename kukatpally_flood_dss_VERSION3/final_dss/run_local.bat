...
pip install --quiet "uvicorn[standard]" websockets fastapi sqlalchemy aiosqlite pandas numpy scikit-learn joblib requests aiohttp aiofiles rasterio matplotlib python-multipart
